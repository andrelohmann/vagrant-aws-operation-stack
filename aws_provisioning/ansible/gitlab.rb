...
external_url 'https://git.showcase.devops-carit.de'
...
gitlab_rails['gitlab_email_from'] = 'git@email.showcase.devops-carit.de'
...
###! install
# gitlab_rails['mattermost_host'] = "https://chat.showcase.devops-carit.de"
...
gitlab_rails['smtp_user_name'] = "AKIAS3B6MWAQ7H4ZZQRD"
gitlab_rails['smtp_password'] = "BMUWz553Pxu/1+RJIumGxpz/mICVKc3/yCpT4HKSO0aB"
gitlab_rails['smtp_domain'] = "email.showcase.devops-carit.de"
...
registry_external_url 'https://docker.showcase.devops-carit.de'
...
mattermost_external_url 'https://chat.showcase.devops-carit.de'
...
letsencrypt['contact_emails'] = ['lohmann.andre@gmail.com'] # This should be an array of email addresses to add as contacts
